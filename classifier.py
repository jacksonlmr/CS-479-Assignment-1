...
# design bayes classifier, case 1 since both classes are modeled by same covariance matrix,
# which is diagonal with equal values
...
def euclidean(mu1, mu2, instance):
    """
    Returns 1 if instance is likely to belong to class 1, 2 if instance is likely to belong to class 2
    """
    x_sub_u_1 = instance - mu1
    x_sub_u_2 = instance - mu2

    g_1 = - (np.linalg.norm(x_sub_u_1) ** 2)
    g_2 = - (np.linalg.norm(x_sub_u_2) ** 2)
